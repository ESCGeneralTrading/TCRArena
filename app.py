...
def advertise():
    if request.method == 'POST':
        ...
        if not name or not email or not contact_number:
            ...
            try:
                msg = Message(
                    subject="New Advertisement Form Submission - TCR Arena",
                    recipients=["digital@thecollectroom.com"]
                )

                msg.body = f"""
                A new advertisement form submission has been received:
                ...
                msg.html = f"""
                <div style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
                  <h2 style="color:#054a9a;">New Advertisement Form Submission - TCR Arena</h2>
                  <p><strong>Name:</strong> {name}</p>
                  <p><strong>Email:</strong> {email}</p>
                  <p><strong>Contact Number:</strong> {contact_number}</p>
                  <p><strong>Message:</strong></p>
                ...
                app.logger.error(f"Failed to send admin email: {e}")

            # --- Send User Acknowledgement ---
            try:
                ack = Message(
                    subject="Thank you for your interest in advertising with TCR Arena",
                    recipients=[email]
                )
                ...
                Thank you for reaching out to TCR Arena regarding advertisement opportunities.
                ...
                ack.html = f"""
                <div style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
                  <h2 style="color:#054a9a;">Thank You for Reaching Out to TCR Arena</h2>
                  <p>Hi {name},</p>
                  <p>Thank you for your interest in advertising with us. Our team has received your request and will contact you soon with more details.</p>
                  <p>We’re excited to explore how we can collaborate to showcase your brand to our passionate community!</p>
                  <br>
                  <p>Best regards,<br><strong>Team TCR Arena</strong></p>
                  <hr>
                  <p style="font-size:12px; color:#777;">This is an automated acknowledgement email. Please do not reply.</p>
                </div>
                """
                mail.send(ack)
            except Exception as e:
                app.logger.error(f"Failed to send acknowledgement email: {e}")
...
def share_collectible_stories():
    if request.method == 'POST':
        ...
        if not name or not email or not contact_number:
            ...
            try:
                ack = Message(
                    subject="Thank you for reaching out - TCR Arena",
                    recipients=[email]
                )
                ack.body = f"""
                Hi {name},

                Thank you for sharing your details with TCR Arena. 
                Our team will review your message and contact you shortly 
                to know more about your story or advertisement request.
                ...
                ack.html = f"""
                <div style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
                  <h2 style="color:#054a9a;">Thank You for Connecting with TCR Arena</h2>
                  <p>Hi {name},</p>
                  <p>Thank you for sharing your details with us. Our team will review your message and get in touch with you soon to know more.</p>
                  <p>We’re excited to hear your story and explore how we can collaborate!</p>
                  <br>
                  <p>Best regards,<br><strong>Team TCR Arena</strong></p>
                  <hr>
                  <p style="font-size:12px; color:#777;">This is an automated acknowledgement email. Please do not reply.</p>
    ...
    return render_template('share_collectible_stories.html')
